 ...
 * Applescrum. Copyright (C) 2013-2017
 *
    ...
    function ajax_change_priority() {
        ...
        if ($getCase) {
            ...
            /* $sqldata = "SELECT case_no,project_id FROM `easycases` WHERE `id`='".$caseId."' ";
              ...
              $sqlinsert = "INSERT INTO `applescrum`.`case_activities` (`easycase_id`, `case_no`, `project_id`, `user_id`, `type`,`dt_created`) VALUES ('".$caseId."','".$dataeasycase['0']['easycases']['case_no']."','".$dataeasycase['0']['easycases']['project_id']."', '".SES_ID."','6','".GMT_DATETIME."')";
...
CompanyUser.company_id=" . SES_COMP . " $usercond) AS total_users $projectcond";
     ...
     * @author GDR<support@Applescrum.com>
     */
