...
class PostcaseComponent extends CookieComponent {
    ...
    function casePosting($formdata) {
        ...
        $cloud_storages = $formdata['cloud_storages']; //By Applescrum
...
####### Case Format
        if (isset($cloud_storages) && !empty($cloud_storages)) { //By Applescrum
...
<span style='font-size:18px;'>Applescrum</span> - Daily Catch-Up Alert
</td>
</tr>
<tr>
...
This is a reminder to post your today's updates to Applescrum. Just reply to this email with the updates, it will be added to the project.
...
//			    
                            if (@$findEmail['User']['id']) {
                                $subject = $fromName . " invited you to join " . CMP_SITE . " on Applescrum";
                                $ext_user = 1;
                            } else {
