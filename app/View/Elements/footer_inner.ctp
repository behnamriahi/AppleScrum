...
<footer <?php if(CONTROLLER == 'easycases' && PAGE_NAME == 'help'){ ?> class="help_footer" <?php } ?> id="footersection">
    ...
    <a href="https://groups.google.com/forum/#!forum/applescrum-community-support" target="_blank" style="margin:0;"><img src="<?php echo HTTP_ROOT."img/google_groups.jpg"; ?>" style="width:100px;"/></a>
    <br/>
		...
		client.on('iotoclient', function (data) {
			...
			if(session_id != SES_ID)          
			{
				...
				//if (window.webkitNotifications) {
					notify(getImNotifyMsg(projShName, caseNum, caseTtl, caseTyp),'Applescrum.com');
				//}
			}
