...
<div>
	...
	<div class="what_feature fl wt_fl_320">
	<a href="http://blog.applescrum.com/2014/01/announcing-open-source-warranty-on-applescrum.html" target="_blank" onclick="opensource_ga()" style="color:#333333;border:none;outline:none"><img  src="<?php echo HTTP_ROOT; ?>img/ftr_3.png?v=<?php echo RELEASE; ?>" alt="" width="43px" height="66px" /></a><br/>
	<a href="http://blog.applescrum.com/2014/01/announcing-open-source-warranty-on-applescrum.html" target="_blank" onclick="opensource_ga()" style="color:#333333"><h4>Open Source Warranty</h4></a>
	There will be no nasty surprises.<br/>In case of any ceased activity, Applescrum will be released as open-source for our customers.
	</div>
</div>
<div class="cb"></div>
<script>
function opensource_ga(){
	  ...
	  <?php if(stristr($_SERVER['SERVER_NAME'],"applescrum.com")){?>
