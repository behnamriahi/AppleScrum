<?php
$metadesc = "Applescrum is an awesome Project Management and Collaboration tool. It helps you to organize projects, team, documents & tasks at one place. No matter where your team or customers are, keep everyone on the same page.";
...
<link rel="image_src" href="<?php echo HTTP_ROOT;?>img/Apple_scrum-logo.jpg" />
				
<meta property="og:title" content="<?php echo $metatitle; ?>" />
<meta property="og:type" content="Website" />
<meta property="og:url" content="<?php echo HTTPS_HOME;?>" />
<meta property="og:image" content="<?php echo HTTP_ROOT;?>img/Apple_scrum-logo.jpg" />
<meta property="og:description" content="<?php echo $metadesc; ?>"/>
<meta property="og:site_name" content="Applescrum" />
