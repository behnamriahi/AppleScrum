...
<div class="steps_os">
	<div class="steps_usr">
		<h1 style="color: #428BCA;">Welcome <?php echo USERNAME; ?>!<br/> Get started with your Applescrum account</h1>
		<h6 style="color: #D67866;font-size: 17px;">You're just 3 simple steps away from exploring Applescrum!</h6>
	</div>
		...
		<tr>
			...
			<td class="onbrd_rt">
				...
				<?php }elseif($totalusers<=1){?>
					...
					Applescrum works best when you add your Co-workers.</h4>
				...
				<?php }else{ $autorefreshflag =1;?>
						<h4 style="text-shadow:none; font-size: 26px;text-align:center">Wow! You have completed all the basics of Applescrum.<br/>
						Now you can get started with Applescrum.</h4><br/>
						<h6>
