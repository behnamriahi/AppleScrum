...
<script type="text/javascript"> 
   function SetName(name) {
	...
	}else if(window.location.host.match(/applescrum.com/g)){
	    domain_set = '.applescrum.com';
	}else if(window.location.host.match(/appleprabhu.com/g)){
	    domain_set = '.appleprabhu.com';
	}
