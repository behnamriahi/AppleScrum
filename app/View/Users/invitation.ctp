...
<?php
if($AuthId) {
	echo "<div style='color:#FF0000'>Please logout from Applescrum and click on the same button from your Email to accept the Invitation.</div>";
}
else {
?>
    	...
    	<div style="display:table-cell; height:100%; min-height:100%; vertical-align:middle">
        	<div style="position:relative">
                ...
                <div class="logo_landing"> 
                        <a href="<?php echo HTTP_HOME; ?>"><img src="<?php echo HTTP_ROOT; ?>img/images/logo_outer.png"  border="0" alt="Applescrum.com" title="Applescrum.com"/></a>
                </div>
