        ...
        <div style="display:table-cell; height:100%; min-height:100%; vertical-align:middle">
            <div style="position:relative; z-index:9;">
                ...
                <div class="logo_landing">
                    <a href="<?php echo HTTPS_HOME; ?>"><img src="<?php echo HTTP_ROOT; ?>img/images/logo_outer.png?v=<?php echo RELEASE; ?>"  border="0" alt="Applescrum.com" title="Applescrum.com"/></a>
                    <?php
					if(!$findCompany['Company']['id']) {
						?>
                        <h4>Welcome to Applescrum Community Edition v1.6.1</h4>
...
<?php
					...
					<div style="padding:10px 5px;">
						...
						<div style="float:left"><a href="https://www.applescrum.com/how-it-works" target="_blank">How it Works?</a></div>
						<div style="float:right;padding-right:10px;"><a href="https://www.applescrum.com/help" target="_blank">Help!</a></div>
					</div>
					<?php
					}
					?>
					   ...
					   <div style="text-align:center;">
						...
						?>
                                    ...
                                    <div style="padding:20px 0;text-align:center">
                                    	<a href="https://groups.google.com/forum/#!forum/applescrum-community-support" target="_blank" style="margin:0;"><img src="<?php echo HTTP_ROOT."img/google_groups.jpg"; ?>"/></a>
                                        <br/>
                                    	You can ask for help, share your ideas, contribute to the community edition and also let us know your feedback using the <a href="https://groups.google.com/forum/#!forum/applescrum-community-support" target="_blank" style="margin:0;">Applescrum's Google Group</a>.
