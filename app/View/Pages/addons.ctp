...
if($addon_name == 'executive_dashboard'){
	$addon_link = "https://www.applescrum.org/addon-details/executivedashboard".$utm_link;
} else if($addon_name == 'user_role_management'){
	$addon_link = "https://www.applescrum.org/addon-details/userrolemanagement".$utm_link;
}else if($addon_name == 'gantt_chart'){
	$addon_link = "https://www.applescrum.org/addon-details/ganttchart".$utm_link;
}else if($addon_name == 'time_log_gold'){
	$addon_link = "https://www.applescrum.org/addon-details/timeloggold".$utm_link;
}else if($addon_name == 'project_template'){
	$addon_link = "https://www.applescrum.org/addon-details/projecttemplate".$utm_link;
}else if($addon_name == 'time_log'){
	$addon_link = "https://www.applescrum.org/addon-details/timelog".$utm_link;
}else if($addon_name == 'task_status_group'){
	$addon_link = "https://www.applescrum.org/addon-details/taskstatus".$utm_link;
}else if($addon_name == 'invoice'){
	$addon_link = "https://www.applescrum.org/addon-details/invoice".$utm_link;
}else if($addon_name == 'document'){
	$addon_link = "https://www.applescrum.org/addon-details/documentmanagement".$utm_link;
}else if($addon_name == 'bug_issue_tracking'){
	$addon_link = "https://www.applescrum.org/addon-details/bugissuetracker".$utm_link;
}else if($addon_name == 'chat'){
	$addon_link = "https://www.applescrum.org/addon-details/chat".$utm_link;
}else if($addon_name == 'expense_management'){
	$addon_link = "https://www.applescrum.org/addon-details/expensemanagement".$utm_link;
}else if($addon_name == 'wiki'){
	$addon_link = "https://www.applescrum.org/addon-details/wiki".$utm_link;
}else if($addon_name == 'recurring_task'){
	$addon_link = "https://www.applescrum.org/addon-details/recurringtask".$utm_link;
}else if($addon_name == 'client_management'){
	$addon_link = "https://www.applescrum.org/addon-details/clientmanagement".$utm_link;
}else if($addon_name == 'mobile_api'){
	$addon_link = "https://www.applescrum.org/addon-details/mobileapi".$utm_link;
}else if($addon_name == 'api'){
	$addon_link = "https://www.applescrum.org/addon-details/api".$utm_link;
}else if($addon_name == 'multilingual'){
	$addon_link = "https://www.applescrum.org/addon-details/multilingual".$utm_link;
}
?>
<div class="mn_pg_dv">
