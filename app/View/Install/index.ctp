<div class="install-wrapper">
    <h2 class="welcome"><?php echo __("Welcome to AppleScrum Community version Installation wizard"); ?></h2>
    <hr />
<?php 
    ...
    <?php }else{ ?>
        ...
        <a href="http://www.applescrum.org/how-to-install-timelog-addon-in-applescrum" class="guide-link"><?php echo __("Go to Installation guide."); ?></a>
    <?php }
?>
</div>
