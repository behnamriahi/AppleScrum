...
class FormatHelper extends AppHelper {
	...
	function imageType($filename,$width1,$height1,$link,$downloadUrl = NULL, $is_ext=NULL)
	{
		 ...
		 if($link == 1) {
		     if(isset($downloadUrl) && trim($downloadUrl)){ //By Applescrum
...
function generateTemporaryURL($resource){
          ...
          //https://s3.amazonaws.com/applescrum-dev/files/case_files/1.jpg?AWSAccessKeyId=AKIAJAVFGWOGKGBOWPWQ&Signature=gZ90JslqYADtRK6haMVR9e2guko%3D&Expires=1360239119
     }
