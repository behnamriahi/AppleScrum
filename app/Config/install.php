...
if(trim($settings['database']) == "") {
	...
	<head>
		...
		<title>Applescrum Setup Wizard</title>
		<style>
		*{
			padding:5;
			margin:5;	
				...
				<table cellpadding="8" cellspacing="8" style="border:1px solid #999999;color:#000000" align="center" width="520px">
					<tr>
						<td align="center" style="border-bottom:1px solid #999999">
							<h3 style="color:#245271">4 simple steps to get started with Applescrum</h3>
						</td>
					</tr>
					<tr>
		...
		<div id="container">
			<div id="content">
				...
				<table cellpadding="8" cellspacing="8" style="border:1px solid #999999;color:#000000" align="center" width="520px">
					<tr>
						<td align="center" style="border-bottom:1px solid #999999">
							<h3 style="color:#245271">2 simple steps to get started with Applescrum</h3>
						</td>
					</tr>
					<tr>
						<td align="left" style="padding-top:10px">
							<h4>Step1: <span style="font-weight:normal;">You have created a database named "<b>Applescrum</b>". But you have no tables in that database. Get the "<b>database.sql</b>" file from the root directory and import that to your database.</span></h4>
					...
					<tr>
						<td>
							...
							<h4><span style="font-weight:normal;">For more information please visit <a href="http://www.applescrum.org/general-installation-guide" target="_blank">Installation Guide</a>.</span></h4>
						</td>
					</tr>
					<tr>
						<td align="center">
		...
		<div id="container">
			...
			<table width="100%" align="center"><tr><td align="center">
				<table cellpadding="8" cellspacing="8" style="border:1px solid #999999;color:#000000" align="center" width="520px">
					...
					<tr>
						<td align="left" style="padding-top:10px">
							<h4>Step1: <span style="font-weight:normal;">Create a new MySQL database  named "<b>applescrum</b>"(`utf8_unicode_ci` collation)</span></h4>
