 ...
 */
	public function initialize(Controller $controller) {
		...
		$this->Banana->testField = 'AppleField';
	}
 ...
 */
	public function testInnerComponentConstruction() {
		...
		$this->assertInstanceOf('AppleComponent', $Component->Apple, 'class is wrong');
	}
 ...
 */
	public function testNestedComponentLoading() {
		...
		$this->assertInstanceOf('AppleComponent', $Apple->Apple, 'class is wrong');
		$this->assertInstanceOf('BananaComponent', $Apple->Apple->Banana, 'class is wrong');
		$this->assertTrue(empty($Apple->Session));
		$this->assertTrue(empty($Apple->Apple->Session));
	}
 ...
 */
	public function testMultipleComponentInitialize() {
		...
		$this->assertSame($Banana, $Apple->Banana, 'Should be references');
		$Banana->testField = 'AppleField';

		$this->assertSame($Banana->testField, $Apple->Banana->testField, 'References are broken');
	}
